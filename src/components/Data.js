export default function data(){
    return{
        ...
        parallaxOne:{
            ...
            content:"Con gran atencion al detalle, todos los diseños son estudiados cuidadosamente al momento del desarroll, adaptanto todos los diseños realizados a Responsive creando asi una aplicacion que se adapte a cualquier dispositivo en cual quier parte del mundo.",
            bg: "parallaxBgOne"
        },
        parallaxTwo:{
